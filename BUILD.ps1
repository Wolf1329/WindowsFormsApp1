...
$exe = 'WindowsFormsApp1.exe'
$mainDir = (Get-Item -Path ".\").FullName
$net_baseoutput = "$mainDir\WindowsFormsApp1\bin\$configuration"
...
function Build-NetFrameworkx64
{
	...
	msbuild  -v:m -m -t:Build /p:Configuration="Release" /p:Platform="Any CPU" /p:TargetFramework=net40
